...
int main(int argc, char const *argv[])
{
    ...
    //TODO: implement game exit and memory cleanup
    ...
    //game loop. currently extremely simple.
    //its current stage means a dead end room will loop forever
    //TODO: add an exit stage
